...
<div align="center">
PaperSnitch is a reviewer-facing decision-support tool that automatically screens MICCAI submissions for reproducibility signals. It parses the paper, checks whether the linked code repository exists and contains real code, and evaluates both against policy-aware checklists. 
